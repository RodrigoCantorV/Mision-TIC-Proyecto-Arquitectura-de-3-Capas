...
class Liquidacion_SueldoCreateView(views.APIView):
    ...
    def post(self,request):
         item = Liquidacion_SueldoSerializer(data=request.data)
         # validating for already existing data
         if Liquidacion_Sueldo.objects.filter(**request.data).exists():
